      ...
      <header className="App-header">
        ...
        <div>
          <p style={{ fontSize: '16px' }}>
            Note: Phantom Wallet may block your access to this dapp, if you are unsure of account's safety, you can
            check my repo{' '}
          </p>
          <a href="https://github.com/Kneel-soN/theblokc-solana-bootcamp/tree/main/nextjs-anchor-dapp" target="_blank" rel="noopener noreferrer">
            Here
          </a>
        </div>
      </header>
